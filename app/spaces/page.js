        ...
        <div className="flex w-full flex-row justify-between bg-neutral-200 p-12">
          ...
          <div className="max-w-xl p-4 pl-16 ">
            ...
            <div className="text-center text-xl leading-relaxed text-black">
              ...
              the costume shop, scene shops, and TAPS faculty and production
              staff offices.
              <br />
              <br />
              Memorial Hall also houses Memorial Auditorium (MemAud), the
              largest indoor performance space at Stanford, which opened in
              1938. Commemorating students and faculty who lost their lives in
              the armed services, MemAud is now primarily used to present
              musicals and dance shows, as well as University special events. It
              features a large proscenium stage, and orchestra and balcony
              seating for over 1700 audience members.
            </div>
          </div>
        </div>
        <div className="flex w-full flex-row justify-between bg-red-100 p-12">
          <div className="max-w-xl p-4 pr-16 ">
            <div className="font-roboto text-center text-5xl font-bold text-black">
              ROBLE GYM
            </div>
            ...
            <div className="text-center text-xl leading-relaxed text-black">
              ...
              <br />
              <br />
              Roble Gymnasium Building re-opened in 2016 as Stanford’s newest
              arts building. Originally built in 1931 as the women’s gymnasium,
              the $28 million renovation created new theatrical performance
              spaces and updated several dance studios, rehearsal spaces, and
              classrooms. Roble houses the Harry J. Elam, Jr. Theater (formerly
              Roble Studio Theater), a large black box theater; the Roble Dance
              Studio, a beautiful dance performance space in keeping with its
              original Spanish architecture; several acting and dance rehearsal
              spaces; the TAPS main office; faculty offices; and administrative
              staff offices. Spaces in Roble Gymnasium Building are managed by
              TAPS.
            </div>
        ...
        <div className="flex w-full flex-row justify-between bg-neutral-200 p-12">
          ...
          <div className="max-w-xl p-4 pl-16 ">
            ...
            <div className="text-center text-xl leading-relaxed text-black">
              ...
              Experimental Nitery Studio. An intimate black-box theater, Nitery
              is outfitted with full lighting, projection, and sound equipment
              for performances. With a flexible seating capacity of 71-83, the
              Nitery features TAPS’s undergraduate capstone projects, graduate
              projects, and other student productions as curated by the
              Experimental Nitery Studio Board. This space is managed by TAPS.
            </div>
            <div className="mt-6 flex flex-row justify-around">
              <div className="font-roboto rounded bg-red-500 px-6 py-2 text-center text-2xl font-bold text-white">
                Building map
