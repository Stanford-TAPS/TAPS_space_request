    ...
    <div className="mx-6 mb-20 mt-4 w-1/3 rounded border bg-white px-16 pt-12 text-xl shadow-lg dark:border-0 dark:bg-neutral-800">
      ...
      <div className="mb-8 flex w-full justify-between pt-8 ">
        <button
          ...
          className="w-24 rounded-lg bg-green-600 p-2 text-white hover:bg-green-500 hover:shadow-md"
        >
          Approve
        </button>
        <button
          onClick={() => setDecision("deny")}
          className="w-24 rounded-lg bg-red-600 p-2 text-white hover:bg-red-500 hover:shadow-md"
        >
          Deny
        </button>
        <button
          onClick={() => setDecision(null)}
          className="w-24 rounded-lg bg-amber-600 p-2 text-white hover:bg-amber-500 hover:shadow-md"
        >
          Edit
        </button>
      </div>
