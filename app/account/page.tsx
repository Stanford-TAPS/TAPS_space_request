...
export default function Account({ asModal = false }) {

    // Get session, from next-auth useSession hook
    const session = useSession();

    if (session.status == "loading") return <Loading />;

    if (session.status == "authenticated") {
        return <div className={asModal ? "" : "flex flex-col items-center justify-center w-full h-full"}>
            <div className={asModal ? "" : "flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0"}>
                <div className="w-full bg-white shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <div className="flex flex-row space-x-3">
                            <SecondaryButton href="#" text="Change Account" onClick={() => signIn("stanford", { callbackUrl: "/account" })} compact={true} />
                            <SecondaryButton href="#" text="Sign Out" onClick={() => signOut()} compact={true} />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div className="w-full bg-white shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <p className="pb-10 text-base font-roboto">
                        You must sign in through Stanford to access certain resources on this site.
                    </p>
                    <PrimaryButton href="#" text="Sign in with Stanford" onClick={() => signIn("stanford", { callbackUrl: "/" })} compact={true} />
                </div>
            </div>
        </div>
    </div>;
